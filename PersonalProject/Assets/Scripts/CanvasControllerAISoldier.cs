...
//public class CanvasControllerAISoldier : MonoBehaviour
//{
...
//    private ClickableObject MoveToObject;
//    //main script for enemies
//    private NPCManager enemyController;
   


//    private void Awake()
//    {
//        enemyController = GetComponentInParent<NPCManager>();
//        UpdateTextAndScale();
//        MoveToObject = GetComponent<ClickableObject>();
//    }
...
//        if (enemyController.currentState == NPCManager.CurrentState.Catching)
//        {
...
//    {
//        infoSoldierName.text = enemyController.npcName.ToString();
//        littleSoldierName.text = enemyController.npcName.ToString();
...
//        if(enemyController.currentState == NPCManager.CurrentState.Patroling)
//        {
//            currentStateValue.text = enemyController.currentState.ToString() + " " + "<color=red><b>" + enemyController.settlement.settlementName + "</b></color>";
//        }
//        else if (enemyController.currentState == NPCManager.CurrentState.Catching)
//        {
//            currentStateValue.text = enemyController.currentState.ToString() + " " + "<color=red><b>" + enemyController.intrectedSoldierName + "</b></color>";
//        }
//        else if (enemyController.currentState == NPCManager.CurrentState.RunningFrom)
//        {
//            currentStateValue.text = enemyController.currentState.ToString() + " " + "<color=red><b>" + enemyController.intrectedSoldierName+ "</b></color>";
//        }
