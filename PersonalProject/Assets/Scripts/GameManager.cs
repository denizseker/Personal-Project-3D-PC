...
public class GameManager : MonoBehaviour
{
    ...
    public void ClearSelectedObjects()
    {
        ...
        if (Instance.selectedObjects.Count == 1)
        {
            ...
            if (Instance.selectedObjects[0].transform.parent.GetComponentInChildren<CanvasControllerSoldier>() != null)
            {
                Instance.selectedObjects[0].transform.parent.GetComponentInChildren<CanvasControllerSoldier>().infoPanel.SetActive(false);
                Instance.selectedObjects[0].transform.parent.GetComponentInChildren<CanvasControllerSoldier>().armySizePanel.SetActive(true);
            }
